...
public class HelloMain {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new GenericXmlApplicationContext("classpath:beanContainer.xml"); //xml파일에서 객체 생성
		
		HelloSingle obj3 = context.getBean("hs", HelloSingle.class); //getBean(): 객체를 얻어옴
